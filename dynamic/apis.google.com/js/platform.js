  ...
  var I = function (a, b, c) {
    ...
    Jb = function (a, b) {
      ...
      b instanceof Oa && b.constructor === Oa
        ? (b = b.R)
        : (za(
            "expected object of type SafeHtml, got '" + b + "' of type " + ia(b)
          ),
      ...
      try {
        ...
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length; ) {
            ...
            f = u(l)
              ? "o" +
                ((Object.prototype.hasOwnProperty.call(l, ma) && l[ma]) ||
                  (l[ma] = ++na))
              : (typeof l).charAt(0) + l;
        ...
        if (null == a) b[b.length] = "null";
          ...
          if (e === fd && Y(a.length) === ad) {
            ...
            for (d = Number(a.length) >> 0; f < d; ++f)
              f && (b[b.length] = ","), (b[b.length] = gd(a[f], c) || "null");
            b[b.length] = "]";
  ...
  window.gapi.load("", {
    ...
    _c: {
      ...
      jsl: {
        ...
        h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.ydLROSGdlBE.O/d=1/rs=AHpOoo_OUY4V-VcsLuRVnUuYVO758FydkA/m=__features__",
