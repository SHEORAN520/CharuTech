  ...
  function (a, b, c, d, e, f) {
    ...
    function va(a) {
      ...
      if (
        ...
        try {
          (c = h("UnhandledRejection: %s", JSON.stringify(b))),
...
__d(
  "PromiseImpl",
  ["TimeSlice", "setImmediateAcrossTransitions"],
  function (a, b, c, d, e, f) {
    "use strict";
    c = a.Env || {};
    d = !!c.gk_use_microtask_promise_polyfill;
    c = ((f = a.queueMicrotask) != null ? f : a.Promise)
      ? function (c) {
          a.Promise.resolve()
            .then(c)
            ["catch"](function (a) {
...
__d(
  "Promise",
  ["ErrorPubSub", "PromiseImpl", "err", "setTimeoutAcrossTransitions"],
  function (a, b, c, d, e, f) {
    "use strict";
    var g;
    c = a.Env || {};
        ...
        var b = Array(a.length),
          c = function (c, d) {
            ...
            b[c] = d
              ...
              : h.resolve({ status: "fulfilled", value: e });
          };
        for (var d = 0, e = a.length; d < e; ++d) c(d, e);
        return h.all(b);
      });
    h.prototype["finally"] ||
      (h.prototype["finally"] = function (a) {
        return this.then(
          function (b) {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = function (a, b, d, e, f, g) {
      ...
      l = {
        string: { logger_id: d },
        int: { first_paint_time: l, response_start_time: m, cbt_delta: b },
      };
      m = {
        int: { client_funnel_version: h, cbt: e },
        string: {},
...
__d(
  "XOAuthErrorController",
  ["XController"],
  function (a, b, c, d, e, f) {
    e.exports = b("XController").create("/oauth/error/", {
      error_code: { type: "Enum", enumType: 1 },
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      ...
      h != null &&
        (a.push("height=" + h), a.push("top=" + (d + (f - h) / 2.5)));
      a.push("scrollbars=1");
      a.push("toolbar=0");
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function l(a, b, d, e, f) {
      new (c("PluginLoginButtonEventsTypedLogger"))()
    ...
    function e(a, b, e, f, g, h, i, j, k, l, n, o, p, q, r, s, t, u, v) {
      ...
      m(a, function (a) {
        ...
        c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function () {
          new (c("PluginLoginButtonEventsTypedLogger"))()
            .setEvent("login_complete")
            .setAppID(b)
            .setLoggerID(n)
            .setIsLegacy(o)
            .setLayout(p)
            .setUseContinueAs(t)
            .setIsContinueAsToggled(u)
            .logVital(),
            d("PlatformOAuthDialogLoginFunnelLogger").log(
              "client_login_end",
              null,
              n,
              !1
    ...
    function f(a, b, e, f, g, k, l, n, o, p, q, r, s, t, u, v, w, x, y) {
      ...
      c("Arbiter").subscribe(
        "Connect.Unsafe.loginButtonStateInit",
        function (a, b) {
          j = b.call;
          if (j != null) {
            a = function () {
      ...
      c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function (a, e) {
        h[e.frame_name] != null &&
          typeof h[e.frame_name].close === "function" &&
          (h[e.frame_name].close(), delete h[e.frame_name]),
          e.status === "connected"
            ? (j = null)
            : c("UnverifiedXD").send({
                type: "login_button_prepare_call",
      ...
      m(a, function (a) {
        ...
        if (j == null)
          ...
          c("UnverifiedXD").send({
            ...
            params: JSON.stringify({ popup: a != null, call: j }),
          });
          if (a != null) {
            h[j.id] = a;
            var e = j.id;
    ...
    function m(a, b) {
      d("PluginDOMEventListener").add(a, "click", b),
        d("PluginDOMEventListener").add(a, "keydown", function (a) {
          a = new (c("DOMEvent"))(a);
