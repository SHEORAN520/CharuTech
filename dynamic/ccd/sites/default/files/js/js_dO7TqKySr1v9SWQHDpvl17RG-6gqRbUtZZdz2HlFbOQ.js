(Drupal.apachesolr_autocomplete = {
    ...
    var o = jQuery.fn.jquery.split("."),
      r =
        (1 == o[0] && o[1] >= 7) || o[0] > 1
          ...
          : "autocomplete",
      l = jQuery(
        ".apachesolr-autocomplete[data-apachesolr-autocomplete-id='" + e + "']",
        a
      );
    l
      .autocomplete({
        source: t.path,
        select: function (e, t) {
          (jQuery(this).get(0).value = t.item.value),
      ...
      l.data(r) &&
        (l.data(r)._renderItem = Drupal.apachesolr_autocomplete.renderItem);
  },
  renderItem: function (e, t) {
    ...
    return (
      console.log(a),
      jQuery("<li>").data("item.autocomplete", t).append(o).appendTo(e)
    );
  },
}),
  (Drupal.behaviors.apachesolr_autocomplete = {
    attach: function (e) {
      Drupal.settings.apachesolr_autocomplete &&
        Drupal.settings.apachesolr_autocomplete.forms &&
        jQuery.each(
          Drupal.settings.apachesolr_autocomplete.forms,
          function (t, a) {
  ...
  (n.DLMenu = function (i, t) {
    ...
    (n.DLMenu.prototype = {
      _init: function (i) {
        ...
        (this.animEndEventName = t[e.prefixed("animation")] + ".dlmenu"),
          (this.transEndEventName = s[e.prefixed("transition")] + ".dlmenu"),
          ...
          this.$menuitems.on("click.dlmenu", function (t) {
            ...
            if (s.length > 0) {
              var o = s
                  .clone()
                  .insertAfter(i.$menu)
                  .addClass(i.options.animationClasses["in"]),
                a = function () {
                  i.$menu
                    .off(i.animEndEventName)
                    .removeClass(i.options.animationClasses.out)
                    .addClass("dl-subview"),
                    e
              ...
              return (
                i.$menu.addClass(i.options.animationClasses.out),
                i.supportAnimations
                  ? i.$menu.on(i.animEndEventName, a)
                  : a.call(),
                !1
              );
            }
          ...
          this.$back.on("click.dlmenu", function (t) {
            var e = n(this),
              ...
              a = s
                .clone()
                .insertAfter(i.$menu)
                .addClass(i.options.animationClasses.out),
              l = function () {
                i.$menu
                  .off(i.animEndEventName)
                  .removeClass(i.options.animationClasses["in"]),
                  a.remove();
              };
            i.$menu.addClass(i.options.animationClasses["in"]),
              i.supportAnimations
            ...
            return (
              u.is("li") && u.addClass("dl-subviewopen"),
              u.removeClass("dl-subview"),
              !1
            );
          });
      },
      ...
      this.each(function () {
        ...
        return e
          ? n.isFunction(e[i]) && "_" !== i.charAt(0)
            ? void e[i].apply(e, t)
            : void o("no such method '" + i + "' for dlmenu instance")
          : void o(
...
function createAccountBySocialLogin(e) {
  $(".loginerror,.loginerrorEmail").text(""),
    $.ajax({
      type: "POST",
      url: site_url + "ajax-user",
      beforeSend: function () {
        $(".contBtn").attr("disabled", !0),
          $(".contBtn").attr("value", "Submitting...");
      },
      data: {
      ...
      dataType: "json",
      success: function (e) {
        200 == e.code || 201 == e.code
          ? (fromtalktousform
              ? $("#userData-talktous,#userpass-talktous").val("")
              : $("#userData,#userpass").val(""),
            $("#user-email,#user-phone").val(""),
            $("#login-popup").fadeOut(0),
            $("#signup-popup").fadeOut(0),
            $("#forgot-password-popup").fadeOut(0),
            $("#offer-popup").fadeOut(0),
            $("#getEmail-popup").fadeOut(0),
            $("#submit-with-login-popup").fadeOut(0),
            fromtalktousform
              ? ($("#talkToUsName").val(e.data.name),
                $("#talkToUsPhone").val(e.data.phone),
                $("#talkToUsEmail").val(e.data.email),
                submitTalktous())
              : ($("#thankyou-popup").fadeIn(300),
                $(".thankyou_message").text(""),
                $(".thankyou_message").text(e.msg),
                window.setTimeout(function () {
                  location.reload();
                }, 2500)))
          : 401 == e.code
          ? ($("#getEmail-popup .forgot-bt").css("display", "block"),
            $(".loginerrorEmail,.loginerror").text(e.msg))
          : $(".loginerrorEmail,.loginerror").text(e.msg);
      },
      complete: function () {
        $(".contBtn").attr("disabled", !1),
          $(".contBtn").attr("value", "SUBMIT");
      },
    });
}
...
function submitTalktous() {
  ...
  $.ajax({
    ...
    data: t,
    beforeSend: function () {
      $(".talkToUsSubmit").attr("disabled", !0),
        $(".talkToUsSubmit").text("Submitting...");
    },
    success: function (e) {
      200 == e.code
        ? ($("#talktoUsForm")[0].reset(),
          $(".talktoUsFormMsgs").text(e.message),
          window.setTimeout(function () {
    ...
    complete: function () {
      $(".talkToUsSubmit").attr("disabled", !1),
        $(".talkToUsSubmit").text("SUBMIT");
    },
  });
}
function trimFormValues(e) {
  for (var t = e.serializeArray(), a = 0, o = t.length; o > a; a++)
    t[a].value = $.trim(t[a].value);
  return t;
}
...
!(function () {
  ...
  function t() {
    var e = $(
      ".main-header .desk-nav-wrapper .desk-parent-nav-ul .desk-parent-nav-li .parent-anchor,.desk-parent-nav-li .child-nav-ul"
    );
    e
      .mouseenter(function () {
        $(this).addClass("active-parent"),
          $(".child-nav-ul").hide(),
          $(this).parent().children(".child-nav-ul").show();
      })
      .mouseleave(function () {
        $(
          ".main-header .desk-nav-wrapper .desk-parent-nav-ul .desk-parent-nav-li .parent-anchor"
        ).removeClass("active-parent"),
          $(".child-nav-ul").hide();
      }),
      $(".main-header .desk-nav-wrapper .desk-parent-nav-li .child-nav-ul")
        .mouseenter(function () {
  ...
  function a() {
    $(
      ".main-header .nav-extras .nav-search-bt,.dl-menuwrapper .mob-search-bt a.nav-search-bt"
    ).click(function (e) {
      e.stopPropagation(),
        $(".serachInput").val(""),
        $("#edit-keys").focus(),
        767 >= winW
          ...
          : ($(".short-active-down-tips").fadeOut(100),
            $(".login-drop-down-wrapper.login-drop").fadeOut(100),
            $(".login-drop-down-wrapper.notify-drop").fadeOut(100),
  ...
  function o() {
    $(
      ".loggin-pop-wrapper .login-inner .nav-form-inputs .userDateOfBirth"
    ).focus(function (e) {
      e.preventDefault(),
      ...
      $(
        ".common-type-input,.loggin-pop-wrapper .login-inner .nav-form-inputs input,.pincode-search .pin-input input"
      ).focus(function () {
        $(this).parent().children("label").fadeOut(0);
      }),
      $(
        ...
        "" == !$(this).val()
          ? $(this).parent().children("label").fadeOut(0)
          : $(this).parent().children("label").fadeIn(300);
      });
  }
  function n() {
    $(".mob-parent-li .login-bts").click(function () {
      ...
      $(".main-header .nav-extras a.nav-notification-bt").click(function (e) {
        $(".nav-search-form").removeClass("search-opened"),
          $(".short-active-down-tips").fadeOut(100),
          $(".login-drop-down-wrapper.login-drop").fadeOut(100),
          $(this).children(".short-active-down-tips").fadeIn(100),
          $(".login-drop-down-wrapper.notify-drop").fadeIn(100),
          e.stopPropagation();
      }),
      $(".main-header .nav-extras a.login-bts").click(function (e) {
        userSession
          ? ($(".nav-search-form").removeClass("search-opened"),
            ...
            $(".login-drop-down-wrapper.notify-drop").fadeOut(100),
            $(this).children(".short-active-down-tips").fadeIn(100),
            $(".login-drop-down-wrapper.login-drop").fadeIn(100),
            e.stopPropagation())
          : (ga("send", "event", "CCD - Form", "Click", "Open"),
            $(".loginerror,.loginerrorEmail").text(""),
            $("#login-popup").fadeIn(300));
      }),
      ...
      $(".loggin-pop-wrapper .login-inner .login-close").click(function () {
        ga("send", "event", "CCD - Form", "Click", "Close"),
          $("#login-popup").fadeOut(0),
          $("#signup-popup").fadeOut(0),
          $("#offer-popup").fadeOut(0),
          $("#getEmail-popup").fadeOut(0);
      ...
      $(".loggin-pop-wrapper .login-inner .sign-in-up-switch.to-up").click(
        function () {
          $("#login-popup").fadeOut(0),
            $("#forgot-password-popup").fadeOut(0),
      ...
      $(".loggin-pop-wrapper .login-inner .sign-in-up-switch.to-in").click(
        function () {
          $("#signup-popup").fadeOut(0),
            $(".loginerror,.loginerrorEmail").text(""),
            $("#login-popup").fadeIn(300);
      ...
      $(
        ".offer-notfication-popup-wrapper .notify-popup-inner .notify-close"
      ).click(function () {
  ...
  function i() {
    var e =
      site_url +
      "apachesolr_autocomplete_callback/apachesolr_search_page?term=";
    $("#edit-keys").autocomplete({
      ...
      $("#edit-keys").data("ui-autocomplete") &&
        ($("#edit-keys").data("ui-autocomplete")._renderItem = function (e, t) {
          var a = "apachesolr_autocomplete_default",
            o = Drupal.theme(a, t);
          return $("<li data-val='" + t.value + "'>")
  ...
  function s() {
    $.validator.addMethod(
      ...
      "Please enter valid input(letters only)."
    ),
      $.validator.addMethod(
        "validEmail",
        function (e, t) {
      ...
      $.validator.addMethod(
        ...
        "Please enter valid input(alphanumeric only)."
      ),
      $.validator.addMethod(
        "validPhoneNo",
        function (e, t) {
  ...
  function l() {
    $(".nav-form-inputs.type-select-gender select").change(function () {
      ...
      $(".profile-details .user-profile-pic .edit-pro-bt").click(function () {
        2 == !$(".nav-form-inputs.type-select-gender select").val() ||
        1 == !$(".nav-form-inputs.type-select-gender select").val()
          ? $(".nav-form-inputs.type-select-gender label").hide()
          : $(".nav-form-inputs.type-select-gender label").show();
      }),
      $(".nav-form-inputs.type-file-inputs .edit-user-pic-input input").change(
        function () {
          var e = $(this).val().split("\\").pop();
          e
            ? $(
                ".nav-form-inputs.type-file-inputs .edit-user-pic-input span"
              ).html(e)
            : $(
                ".nav-form-inputs.type-file-inputs .edit-user-pic-input span"
              ).html("Upload your picture");
        }
      );
  }
  $(window).load(function () {
    e(),
      $(".SocialCorner").attr("href", "http://maythebrewbewithyou.tumblr.com/"),
      $(".SocialCorner").attr("rel", "nofollow"),
      $(".SocialCorner").attr(
        "onclick",
        "ga('send', 'event', 'CCD - Home', 'Link Click', 'Soical Corner');"
      ),
      $(".Blog").attr("href", "http://maythebrewbewithyou.tumblr.com/"),
      $(".Blog").attr("rel", "nofollow"),
    ...
    $(document).ready(function () {
      t(),
        ...
        l(),
        i(),
        $("#userDateOfBirth,#userDateOfBirth1").datepicker({
        ...
        $(".dl-menuwrapper li.mob-parent-li").click(function () {
          $(this).children("ul").hasClass("dl-submenu") ||
            $(".dl-menuwrapper button.dl-active").trigger("click");
        }),
        $("#searchQuerySubmit").click(function (e) {
          ...
          if (r)
            if (t.test(r)) {
              ...
              $(".searchFormError").text("Please enter the valid search query"),
                window.setTimeout(function () {
                  $(".searchFormError").text("");
                }, 1500);
          else
            $(".searchFormError").text("Please enter the search query"),
              window.setTimeout(function () {
                $(".searchFormError").text("");
              }, 1500);
        }),
          ...
          if (13 == e.keyCode) {
            ...
            if (r)
              if (t.test(r)) {
                ...
                $(".searchFormError").text(
                  "Please enter the valid search query"
                ),
                  window.setTimeout(function () {
                    $(".searchFormError").text("");
                  }, 1500);
        ...
        $(document).on(
          "click",
          ".fixed-page-form span.talk-button-toggler",
          function (e) {
            if (
              ($(this).parent().toggleClass("actived"),
              $(this).parent().hasClass("actived") && userSession)
            ) {
  ...
  $(document).on("click", ".signUp-btn", function (e) {
    ...
    fromtalktousform
      ? ((t = $("#name-talktous").val()),
        (a = $("#email-talktous").val()),
        (o = $("#mobile-talktous").val()),
        (n = $("#pass-talktous").val()))
      : ((t = $("#name").val()),
        (a = $("#email").val()),
        (o = $("#mobile").val()),
    ...
    var r = /^\S*$/,
      ...
      s = /^[789]\d{9}$/;
    "" == t
      ? $(".signUpErrors").text("Please enter user name")
      : "" == a
      ? $(".signUpErrors").text("Please enter email")
      : i.test(a)
      ? "" == o
        ? $(".signUpErrors").text("Please enter mobile number")
        : s.test(o)
        ? "" == n
          ? $(".signUpErrors").text("Please enter password")
          : n.length < 6
          ? $(".signUpErrors").text(
              "Please enter password of length atleast 6 characters"
            )
          : r.test(n)
          ? ((profile = { name: t, email: a, mobile: o, password: n }),
            $.ajax({
              type: "POST",
              url: site_url + "ajax-user",
              beforeSend: function () {
                $(".signUp-btn").attr("disabled", !0),
                  $(".signUp-btn").attr("value", "Submitting..");
              },
              data: {
                profile: profile,
                method: "userSignUp",
              ...
              success: function (e) {
                200 == e.code
                  ? (ga("send", "event", "CCD - Sign up", "Click", "Submit"),
                    $("#login-popup").fadeOut(0),
                    $("#signup-popup").fadeOut(0),
                    $("#forgot-password-popup").fadeOut(0),
                    $("#offer-popup").fadeOut(0),
                    ...
                    fromtalktousform
                      ? ($("#submit-with-login-popup").fadeOut(0),
                        $(
                          "#name-talktous,#email-talktous,#mobile-talktous,#pass-talktous"
                        ).val(""),
                        $("#talkToUsName").val(e.data.name),
                        $("#talkToUsPhone").val(e.data.phone),
                        $("#talkToUsEmail").val(e.data.email),
                  ...
                  : $(".signUpErrors").text(e.msg);
              },
              complete: function () {
                $(".signUp-btn").attr("disabled", !1),
                  $(".signUp-btn").attr("value", "Submit");
              },
            }))
          : $(".signUpErrors").text(
              "Please enter valid password spaces not allowed"
            )
        : $(".signUpErrors").text("Please enter valid mobile number")
      : $(".signUpErrors").text("Please enter valid email");
  }),
  $(document).on("click", ".user-login-btn", function (e) {
    ...
    var t = $("#userData").val(),
      ...
      n = /^[789]\d{9}$/;
    "" == t
      ? $(".loginerror").text("Please enter email Id / phone no")
      : o.test(t) || n.test(t)
      ? "" == a
        ...
        : $.ajax({
            ...
            url: site_url + "ajax-user",
            beforeSend: function () {
              $(".user-login-btn").attr("disabled", !0),
                $(".user-login-btn").attr("value", "Submitting...");
            },
            data: {
              userData: t,
              password: a,
            ...
            success: function (e) {
              200 == e.code || 201 == e.code
                ...
                : $(".loginerror").text(e.msg);
            },
            complete: function () {
              $(".user-login-btn").attr("disabled", !1),
                $(".user-login-btn").attr("value", "SUBMIT");
            },
          })
  ...
  $(document).on("click", ".chkRegisteredEmailBtn", function (e) {
    ...
    "" == a
      ? $(".forgotPassFormErr").text("Please enter email Id")
      : t.test(a)
      ? $.ajax({
          type: "POST",
          url: site_url + "ajax-user",
          beforeSend: function () {
            $(".chkRegisteredEmailBtn").attr("disabled", !0),
              $(".chkRegisteredEmailBtn").attr("value", "Submitting...");
          },
          data: { method: "checkRegisteredEmail", email: a },
          dataType: "json",
          success: function (e) {
            200 == e.code
              ? ($("#registeredEmail").val(""),
              ...
              : $(".forgotPassFormErr").text(e.msg);
          },
          complete: function () {
            $(".chkRegisteredEmailBtn").attr("disabled", !1),
              $(".chkRegisteredEmailBtn").attr("value", "SUBMIT");
          },
        })
  ...
  $(document).on("click", ".forgotPassBtn", function (e) {
    ...
    "" == a
      ? $(".forgotPassFormErr").text("Please enter new password")
      : t.test(a)
      ? a.length <= 6
        ? $(".forgotPassFormErr").text(
            "Please enter valid password(length should be more than 6 characters)"
          )
        : "" == o
        ? $(".forgotPassFormErr").text("Please enter confirm password")
        : a != o
        ? $(".forgotPassFormErr").text("Passwords do not match.")
        : $.ajax({
            type: "POST",
            url: site_url + "ajax-user",
            beforeSend: function () {
              $(".forgotPassBtn").attr("disabled", !0),
                $(".forgotPassBtn").attr("value", "Submitting...");
            },
            data: { method: "saveNewPassword", newPassword: a, userId: n },
            dataType: "json",
            success: function (e) {
              200 == e.code
                ? ($("#newPass").val(""),
            ...
            complete: function () {
              $(".forgotPassBtn").attr("disabled", !1),
                $(".forgotPassBtn").attr("value", "SUBMIT");
            },
          })
      : $(".forgotPassFormErr").text(
          "Please enter valid password spaces not allowed"
  ...
  $(document).on("click", ".contBtn", function (e) {
    ...
    var t = $("#user-email").val(),
      ...
      n = /^[789]\d{9}$/;
    "" == t
      ? $(".loginerrorEmail").text("Please enter email address.")
      : o.test(t)
      ? "" == a
        ? $(".loginerrorEmail").text("Please enter Phone no.")
        : n.test(a)
        ? ((profileData.email = t),
          (profileData.phone = a),
          createAccountBySocialLogin(profileData))
        : $(".loginerrorEmail").text("Please enter valid Phone no.")
      : $(".loginerrorEmail").text("Please enter a valid email address.");
  }),
  $(window).click(function () {
    $(".short-active-down-tips").fadeOut(100),
      $(".login-drop-down-wrapper").fadeOut(100),
      767 >= winW
        ? $(".nav-search-form").slideUp(200)
        : $(".nav-search-form").removeClass("search-opened");
  }),
  $(document).on("change", ".deliveryCity", function (e) {
    ...
    if ((ga("send", "event", "CCD - Home Delivery", "Click", o), a in t)) {
      ...
      $.each(t[a], function (e, t) {
        "Swiggy" == t
          ? (n +=
              '<a class="transition delivery-links" target="_blank" rel="nofollow" data-item="Swiggy" href="https://www.swiggy.com/"><span>Swiggy</span><i class="ion-ios-close-empty"></i></a>')
          : "Zomato" == t
          ? (n +=
              '<a class="transition delivery-links" target="_blank" data-item="Zomato" rel="nofollow" href="https://www.zomato.com/"><span>Zomato</span><i class="ion-ios-close-empty"></i></a>')
          : "Foodpanda" == t &&
            (n +=
              '<a class="transition delivery-links" target="_blank"  data-item="Foodpanda" rel="nofollow"  href="https://www.foodpanda.in/"><span>Foodpanda</span><i class="ion-ios-close-empty"></i></a>');
      }),
  ...
  $(document).on("click", ".delivery-links", function (e) {
    ...
    var t = $(this).attr("data-item"),
      a = $(this).attr("href");
    ga("send", "event", "CCD - Home Delivery", "Click", t),
      window.open(a, "_blank");
  }),
  $(document).on("click", ".talkToUsSubmit", function (e) {
    return (
      e.preventDefault(),
      $(".talktoUsFormMsgs,.signUpErrors").text(""),
      $("#talktoUsForm").valid() &&
        (userSession
          ? submitTalktous()
          : ((fromtalktousform = 1),
            $("#submit-with-login-popup").fadeIn(400))),
      !1
    );
  });
          ...
          success: function (e) {
            200 == e.code || 201 == e.code
              ...
              : ($(".emailDiv").show(),
                profileData.email &&
                  ($(".emailDiv").hide(),
                  $("#user-email").val(profileData.email),
                  $("#user-email").attr("type", "hidden")),
                $("#offer-popup").css("display", "none"),
                $("#login-popup").css("display", "none"),
                $("#getEmail-popup").css("display", "block"));
          },
        });
    }
  );
...
$(document).on("click", ".social-login-wrapper .log-fb", function (e) {
  ...
  (function (e, o, a) {
    var t,
      i = e.getElementsByTagName(o)[0];
    e.getElementById(a) ||
      (((t = e.createElement(o)).id = a),
        ...
        success: function (e) {
          200 == e.code || 201 == e.code
            ...
            : ($(".emailDiv").show(),
              ...
              $("#login-popup").css("display", "none"),
              $("#getEmail-popup").css("display", "block"),
              $("#getEmail-popup .forgot-bt").css("display", "none"));
        },
      }),
      (signInClick = 0));
}
...
$(document).on(
  "click",
  "#google-signinbtn1,#google-signinbtn2,#google-signinbtn3",
  function (e) {
    signInClick = 1;
  }
);
      ...
      this.each(function () {
        ...
        if (n.data("ajaxUploader-setup") !== !0) {
          n.change(function () {
            ...
            null == a.submit_button ||
              a.submit_button.click(function (t) {
          ...
          var i = function () {
            ...
            if (
              !0 === a.validate_extensions &&
              -1 == t.inArray(i, a.valid_extensions)
            )
              a.onComplete.apply(n, [
                {
                  status: !1,
                  message:
                    "The select file type is invalid. File must be " +
                    a.valid_extensions.join(", ") +
                    ".",
                },
                a.params,
              ]);
          ...
          var o = function (n, i) {
              ...
              i.siblings().remove(),
                i.unwrap(),
                (e = !1),
                a.onComplete.apply(i, [o, a.params]);
            },
            r = function (n) {
              var e =
                "ajaxUploader-iframe-" + Math.round(new Date().getTime() / 1e3);
              t("body").after(
...
$(window).load(function () {
  return "Notification" in window
    ? void ("granted" !== Notification.permission
        ? $(".getnotified").css("display", "block")
        : "granted" === Notification.permission
        ? ($(".getnotified").css("display", "none"),
          createNotificaitons(desktopnotification))
        : console.log("Desktop notifications are not allowed"))
    : void console.log("This browser does not support desktop notifications");
}),
  $(document).on("click", ".getNotifiedEnableBtn", function (o) {
    o.preventDefault(),
      console.log("getNotifiedEnableBtn"),
      Notification.requestPermission(function (o) {
        console.log(o),
          "granted" === o &&
            ($(".getnotified").css("display", "none"),
            createNotificaitons(desktopnotification));
